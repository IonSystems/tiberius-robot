...
class RobotForm(forms.ModelForm):
    ...
    class Meta:
        model = Robot
        fields = ['name', 'ip_address', 'mac_address', 'weight', 'capacity', 'owner', 'permitted_users',
                  'control_enabled', 'autonomy_enabled', 'object_detection_enabled', 'database_enabled', 'image']
        widgets = {
