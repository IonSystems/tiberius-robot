    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(default=b'0', on_delete=django.db.models.deletion.CASCADE, related_name='robot_owner', to=settings.AUTH_USER_MODEL)),
                ('permitted_users', models.ManyToManyField(related_name='robot_permitted_users', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
