...
def reading():
    ...
    X_c = (coeff[0]*(X_nc-coeff[9]))+(coeff[1]*(Y_nc-coeff[10]))+(coeff[2]*(Z_nc-coeff[11]))
    Y_c = (coeff[3]*(X_nc-coeff[9]))+(coeff[4]*(Y_nc-coeff[10]))+(coeff[5]*(Z_nc-coeff[11]))
    Z_c = (coeff[6]*(X_nc-coeff[9]))+(coeff[7]*(Y_nc-coeff[10]))+(coeff[8]*(Z_nc-coeff[11]))
